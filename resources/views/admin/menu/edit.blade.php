                        ...
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <select id="parent_id" name="parent_id" class="form-control">
                                ...
                                @foreach ($menuData as $row)
                                    <option value="{{ $row->id }}"
                                        {{ $row->id == $menu->parent_id ? 'selected' : '' }}>
                                        {{ $row->name }}</option>
                                @endforeach
                            </select>
                            @error('parent_id')
                        ...
                        <div class="mt-2 form-group col-md-4 col-sm-12">
                            ...
                            <select id="is_open_new_tab" name="is_open_new_tab" class="form-control">
                                <option selected value="1"
                                    {{ old('is_open_new_tab', $menu->is_open_new_tab) == '1' ? 'selected' : '' }}>
                                    Active</option>
                                <option value="0"
                                    {{ old('is_open_new_tab', $menu->is_open_new_tab) == '0' ? 'selected' : '' }}>
                                    Inactive
                                </option>
                            </select>
                        </div>
                        <div class="mt-2 form-group col-md-4 col-sm-12">
                            ...
                            <select id="status" name="is_active" class="form-control">
                                <option selected value="1"
                                    ...
                                    Active</option>
                                <option value="0"
                                    {{ old('is_active', $menu->is_active) == '0' ? 'selected' : '' }}> Inactive
                                </option>
                            </select>
                        </div>
